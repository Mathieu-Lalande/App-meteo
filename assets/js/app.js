 ...
 * @param {string} eventType event type ex: "click", "change"
                    ...
                    <ul class="view-list" data-search-list>
                        <li class="view-item">
                            ...
                            <div>
                                ...
                                <p class="label-2 item-subtitle">Ville de Paris, France</p>
    ...
    */
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        */
        ...
        fetchData(url.airPollution(lat, lon), function (air_pollution) {
            const [{
                main: { aqi },
